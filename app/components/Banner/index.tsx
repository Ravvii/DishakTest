                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        <h2 className='mainlogo'>
                            <span className='brandColor'>DISHAK: Connect. Grow.</span>
                        </h2>
                        <h1 className='text-midnightblue text-sml text-center lg:text-start weightBold lh-133 pt-5'>Driving Innovation, <br />Empowering Success.</h1>
                        <h3 className='text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8'>
                            <span className='brandColor'>DISHAK</span>'s Engineering and Training team manifests your vision into concrete solutions.
                        </h3>
