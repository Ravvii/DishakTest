        ...
        <div className="mx-auto max-w-7xl pt-10 sm:pb-24 px-6">
            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                ...
                <div className='col-span-6 flex flex-col justify-center'>
                    ...
                    <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-3'>Look no further! DISHAK provides fully trained and job-ready professionals, slashing training costs.
                        Need to upskill your team? Our practical, real-world training has you covered.
                    </h3>
