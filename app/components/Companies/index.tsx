...
const Companies = () => {
    return (
        <div className='text-center my-20 mb-0 bg-lightBlue'>
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 py-6">
            <h3 className="text-4xl sm:text-5xl font-semibold text-black text-center my-10 font-family">Who Needs Dishak?</h3>
                {/* <h2 className="text-midnightblue text-2xl font-semibold">Who Needs Dishak?</h2> */}
                <div className="py-14 pb-0">
                    {/* <Slider {...settings}>
                        {data.map((item, i) =>
                            <div key={i}>
