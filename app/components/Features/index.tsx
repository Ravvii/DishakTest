...
const Features = () => {
    return (
        <div className="bg-babyblue" id="features">
            <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 py-6">
                <h3 className="text-4xl sm:text-5xl font-semibold text-black text-center my-10">How Do We Help You?</h3>
                <h5 className="text-black opacity-60 text-lg font-normal text-center"><span className='brandColor'>DISHAK</span>'s experienced team of professionals is here to accelerate your success <br /> with three of our major service verticals as listed below.</h5>
                <div className="mx-auto max-w-7xl pt-10 sm:pb-24 px-6">
                    ...
                    <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                            ...
                            <div className='col-span-6 flex justify-center'>
                                <Image src="/assets/business/Corporate-Employees-Training.png" alt="payment" width={600} height={600} />
                            </div>

                            <div className='col-span-6 flex flex-col justify-center lg:pl-24 lg:mt-0'>
                                <h2 className='text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-143'>Corporate Empowerment</h2>
                                <h3 className='text-black text-lg font-normal text-center lg:text-start lh-173 opacity-75 pt-3'>We elevate your team's skills for career growth and organizational success with our comprehensive corporate training that equips them with technical expertise and essential career skills.</h3>
                                <Link href={'/'} className="text-midorange text-lg font-medium flex gap-2 pt-4 mx-auto lg:mx-0">
                                    Learn more <Image src="/assets/people/arrow-right.svg" alt="arrow-right" width={24} height={24} />
                                </Link>
                            </div>
